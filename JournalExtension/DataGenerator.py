...
class DatasetLoader(Dataset):
    ...
    def __init__(self, dir, d_type):
        ...
        self.depth_path = os.path.join(dir, str(d_type), 'Depth')

        self.X = os.listdir(self.x_path)
        self.Y = os.listdir(self.y_path)
        self.depth = os.listdir(self.depth_path)
    ...
    def __getitem__(self, index):
        ...
        depth_full_path = os.path.join(self.depth_path, self.depth[index])
        ...
        depth = Image.open(depth_full_path).convert('RGB')
